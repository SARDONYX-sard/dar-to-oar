...
impl<'a> From<PluginValue<'a>> for Keyword<'a> {
    #[inline]
    fn from(value: PluginValue<'a>) -> Self {
        Self::Form(FormValue { form: value })
    }
}
...
mod tests {
    ...
    #[test]
    fn should_serialize_keyword_default() -> Result<(), serde_json::Error> {
  ...
  "editorID": ""
    ...
    #[test]
    fn should_deserialize_keyword_enum_literal() -> Result<(), serde_json::Error> {
        let input = r#"{
  "editorID": "SomeKeyword"
    ...
    #[test]
    fn should_serialize_keyword_enum_form() -> Result<(), serde_json::Error> {
  ...
  "form": {
    ...
    #[test]
    fn should_deserialize_keyword_enum_form() -> Result<(), serde_json::Error> {
        let input = r#"{
  "form": {
    "pluginName": "MyPlugin",
    "formID": "12345"
